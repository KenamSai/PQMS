          ...
          views: [
            Container(
              child: WebView(
                ...
                initialUrl: Uri.parse(WebUrlConstants.privacypolicy).toString(),
            ...
            Container(
              child: WebView(
                ...
                initialUrl:
                    Uri.parse(WebUrlConstants.termsAndConditions).toString(),
                javascriptMode: JavascriptMode.unrestricted,
              ),
            ),
            Container(
              child: WebView(
                ...
                initialUrl:
                    Uri.parse(WebUrlConstants.copyrightPolicy).toString(),
                javascriptMode: JavascriptMode.unrestricted,
              ),
            ),
          ],
